            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-10 m-auto">
                        <p class="text-uppercase mb-0"><a href="<?php echo $root_link?>/novedades.php"  class="disable_link">Novedades</a> > Censos de Arbolado: nuestra aplicación llegó a La Francia, Córdoba</p>
                    </div>
                </div>
            </div>
        </section> 
                    ...
                    <div class="col-lg-10 m-auto">
                        <div class="row">
                            <div class="col-lg-9">
                                ...
                                <!-- Titulo Novedad -->
                                <h3 class="text_green text-uppercase my-3">Censos de Arbolado: nuestra aplicación llegó a La Francia, Córdoba</h3>
                                <!--Texto Principal y Footage Principal -->
                                <div class="d-flex flex-column-reverse flex-md-column">
                                    <p class="mt-2" style="text-align: justify">El área de Medioambiente Municipal de la localidad cordobesa de San Justo comenzó a utilizar la APP MuniArbolado para geolocalizar cada árbol de la zona y así gestionar el planeamiento de nuevas plantaciones a través de la detección de faltantes y riesgos.</p>
                                    <p class="mt-2" style="text-align: justify">La funcionaria municipal Carmen Molina Fernandez, le anticipó al diario La Voz de San Justo que "el principal objetivo es planificar una campaña de reforestación y también saber si hay árboles históricos para proceder al cuidado más intensivo de estas plantas".</p>
                                    <p class="mt-2 mb-0" style="text-align: justify">Esta herramienta de MuniDigital permite registrar el tipo de especie, edad aproximada del árbol, detectar peligros en mal estado, enfermedad o tamaño y geoposicionamiento.</p>
                                    <!-- Footage Principal -->
