            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-10 m-auto">
                        <p class="text-uppercase mb-0"><a href="<?php echo $root_link?>/novedades.php"  class="disable_link">Novedades</a> > MuniDigital realizó una Masterclass online sobre Arbolado Urbano</p>
                    </div>
                </div>
            </div>
        </section> 
                        ...
                        <div class="row">
                            <div class="col-lg-9">
                                ...
                                <div class="d-flex flex-column-reverse flex-md-column">
                                    <p class="mt-2" style="text-align: justify">El 28 de julio de 2021 MuniDigital llevó a cabo una Masterclass online y gratuita sobre Arbolado Urbano, en donde disertó Ana Clara Cobas, Dra. en Ciencias Agrarias y Forestales, Investigadora del CONICET y docente de la UNNOBA.</p>
                                    <p class="mt-2" style="text-align: justify">Con todos los cupos agotados, el workshop tuvo como eje central destacar la importancia del censado de árboles, sus ventajas y diferentes consejos sobre cómo hacerlo a través de la aplicación de MuniDigital.</p>
                                    <p class="mt-2 mb-0" style="text-align: justify">“El censo forestal es una herramienta muy útil para mantener y cuidar el arbolado urbano”, concluyó la Dra. Cobas. De esta manera, se demostró la relevancia del censado del arbolado urbano y la eficacia de hacerlo a través de herramientas digitales.</p>
                                    <!-- Footage Principal -->
