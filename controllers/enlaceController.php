...
class EnlaceController
{
    ...
    public function getPage()
    {
        ...
        //Vistas de client
        $client = ["index", "acceso-clientes", "campanas", "casos-de-exito", "demo-gratuita", "nosotros", "contacto", "novedad-01","novedad-02","novedad-03","novedad-04","novedad-05","novedad-06", "novedades", "soluciones"];
