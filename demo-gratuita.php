...
<body style="">
    ...
    <main>
        <section class="page_general_bg" style="background-image: url('<?php echo $root_link?>/assets/images/demo-gratuito/bg-demo-gratuita.jpg');">
            <div class="container h-100">
                <div class="row align-items-center h-100">
                    ...
                    <div class="col-md-5 m-auto d-none d-lg-inline-block">
