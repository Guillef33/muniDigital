...
<body style="">
    ...
    <main>
                ...
                <div class="row h-100 align-items-center">
                    ...
                    <div class="col-12 col-lg-5 m-auto"> 
                        <div class="bg_acceso_clientes_form">
                            <h3 class="text_green fw-bold mb-3 text-uppercase">Iniciar Sesión</h3>
                            <form action="" class="row" id="formulario-soluciones">
                                ...
                                <div class="col-lg-12 mb-2 mb-lg-3">
                                    <input type="password" placeholder="Contraseña" class="w-100" id="password" name="password" required>
                                </div>
                                <div class="col-lg-6 mb-2 mb-lg-3 ">
                                    <div class="d-flex align-items-center justify-content-center justify-content-lg-start">
                                        <input type="checkbox" placeholder="Contraseña" id="showpass" name="showpass">
                                        <label class="d-inline-block ms-2" for="showpass">Mostrar Contraseña</label>
                                    </div>
                                </div>
                                <div class="col-lg-6 mb-2 mb-lg-3 text-center text-lg-end">
                                    <a href="#" class="text_green disable_link">¿Olvidaste tu contraseña?</a>
                                </div>
        ...
        <section class="my-5" >
            <div class="container ">
                <h3 class="text_green text-uppercase mb-4 text-center text-titulo-grande"> <b> ¿Todavía no eres cliente?</b></h3>
                <div class="row">
