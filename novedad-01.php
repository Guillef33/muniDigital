            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-10 m-auto">
                        <p class="text-uppercase mb-0"><a href="<?php echo $root_link?>/novedades.php"  class="disable_link">Novedades</a> > Lanzamiento de APP Ciudadana en Córdoba</p>
                    </div>
                </div>
            </div>
        </section> 
                    ...
                    <div class="col-lg-10 m-auto">
                        <div class="row">
                            <div class="col-lg-9">
                                ...
                                <!-- Titulo Novedad -->
                                <h3 class="text_green text-uppercase my-3">Lanzamiento de APP Ciudadana en Córdoba</h3>
                                <!--Texto Principal y Footage Principal -->
                                <div class="d-flex flex-column-reverse flex-md-column">
                                    <p class="mt-2 mb-0" style="text-align: justify">MuniDigital estuvo presente en el evento del lanzamiento de la APP Ciudadana de la Municipalidad de Córdoba, realizada el viernes 19 de marzo de 2021. Con esta aplicación, los vecinos podrán participar de forma proactiva en el mejoramiento de su propia ciudad, reportando distintos datos que serán de gran ayuda para las distintas áreas municipales. La misma es una herramienta invaluable para la gestión de reclamos, simplificando los trámites y pasos a seguir.</p>
                                    <!-- Footage Principal -->
