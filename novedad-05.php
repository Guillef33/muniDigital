            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-10 m-auto">
                        <p class="text-uppercase mb-0"><a href="<?php echo $root_link?>/novedades.php"  class="disable_link">Novedades</a> > El Govtech según Alejandra Torres y el trabajo de MuniDigital en la Municipalidad de Córdoba</p>
                    </div>
                </div>
            </div>
        </section> 
                    ...
                    <div class="col-lg-10 m-auto">
                        <div class="row">
                            <div class="col-lg-9">
                                ...
                                <!-- Titulo Novedad -->
                                <h3 class="text_green text-uppercase my-3">El Govtech según Alejandra Torres y el trabajo de MuniDigital en la Municipalidad de Córdoba</h3>
                                <!--Texto Principal y Footage Principal -->
                                <div class="d-flex flex-column-reverse flex-md-column">
                                    <p class="mt-2" style="text-align: justify">“GovTech es una corriente moderna y reciente que está liderando el mundo. Es una articulación del sector público con las startups digitales para mejorar los procesos y eficiencia de las gestiones de la administración pública”, explica Alejandra Torres, Secretaria de Planeamiento, Modernización y Relaciones Internacionales de la Municipalidad de Córdoba, y referente latinoamericana en la materia.</p>
                                    <p class="mt-2" style="text-align: justify">Desde MuniDigital estamos trabajando para lanzar una nueva aplicación que recoja los reclamos de los vecinos a través de una herramienta sencilla y que, a su vez, permita realizar la trazabilidad de la gestión de la Municipalidad.</p>
                                    <p class="mt-2 mb-0" style="text-align: justify">“Esto es mucho más que una APP de reclamos, es una herramienta que le permite a la administración mirar internamente cómo va gestionando y así calificar y obtener datos sobre si vamos bien, mal o si tenemos que hacer algún corrimiento”, asegura la Secretaria.</p>
                                    <!-- Footage Principal -->
                                ...
                                <div class="row mt-4">
                                    ...
                                    <div class="col-12 mt-3">
                                        <a href="<?php echo $root_link?>/novedad-02.php" class="m-0 d-block novedad_wrapper">
                                            ...
                                            <div class="novedad_title_bgGreen">
                                                <h6 class="text-white m-0 py-2 text-center">Presentación de la app<br class="d-none d-lg-inline-block">Barranqueras Digital</h6>
                                            </div>
                                        </a>
                                    </div>
                                     <!-- Item -->
