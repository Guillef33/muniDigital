            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-10 m-auto">
                        <p class="text-uppercase mb-0"><a href="<?php echo $root_link?>/novedades.php"  class="disable_link">Novedades</a> > Conocé más sobre MuniDigital</p>
                    </div>
                </div>
            </div>
        </section> 
                    ...
                    <div class="col-lg-10 m-auto">
                        <div class="row">
                            <div class="col-lg-9">
                                ...
                                <!-- Titulo Novedad -->
                                <h3 class="text_green text-uppercase my-3">Conoce más sobre MuniDigital</h3>
                                <!--Texto Principal y Footage Principal -->
                                <div class="d-flex flex-column-reverse flex-md-column">
                                    <p class="mt-2" style="text-align: justify">MuniDigital ofrece las soluciones necesarias que cada gestión necesita a nivel municipal, provincial o nacional.</p>
                                    <p class="mt-2" style="text-align: justify">Nuestro software ayuda a reducir recursos públicos en un 500%, ahorrar tiempo de los trabajadores municipales y vecinos hasta cuatro veces e incrementar la satisfacción ciudadana en un 88%.</p>
                                    <p class="mt-2 mb-0" style="text-align: justify">Nuestra herramienta principal es una plataforma web y una aplicación intuitiva que permite la gestión de los servicios públicos mediante el seguimiento de los incidentes denunciados por ciudadanos y funcionarios públicos.</p>
                                    <!-- Footage Principal -->
                                    <div class="yt_videos_size_w100 w-100 mt-3">
